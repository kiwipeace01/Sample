    ...
    for response in responsesCol.find({"user": userName}):
        if(response["question"] in type1):
            ...
            if(response["question"] in type2 and response["question"]==7):
                ...
                "%moroccan": response["%moroccan"],
                "%"+"lebanese": response["%"+"lebanese"],
                "%"+"european": response["%"+"european"],
                "%"+"arab": response["%"+"arab"],
                "%"+"asian": response["%"+"asian"],
                "%"+"american_indian": response["%"+"american_indian"],
                "%two_or_more_races": response["%two_or_more_races"],
                "%pacific_islander": response["%pacific_islander"],
                "%"+"hispanic": response["%"+"hispanic"],
